 ...
 * Uses the ThemeContext to manage theme state and persists the preference in localStorage.
 *
 * Features:
 * - Smooth theme switching with immediate visual feedback
 * - Accessible with proper ARIA labels
 * - Responsive SVG icons for light/dark modes
